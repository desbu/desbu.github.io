...
function countArea() {
    ...
    if (select.value == 'house' || select.value == 'garden-house') {
        ...
        if (area > basisArea) {
            prices[0].innerText = `${Math.ceil(((basisArea * 13 + (area - basisArea) * basisArea / area * 13) * k1 * k2 * k3 / 10) * 1.2) * 10 + 100 - eng} BYN`;
            prices[1].innerText = `${Math.ceil(((basisArea * 21 + (area - basisArea) * basisArea / area * 21) * k1 * k2 * k3 / 10) * 1.2) * 10 + 100 - eng} BYN`;
            prices[2].innerText = `${Math.ceil(((basisArea * 47 + (area - basisArea) * basisArea / area * 47) * k1 * k2 * k3 / 10) * 1.2) * 10 + 100 - eng + geology} BYN`;
        } else if (area > 0) {
            if (area < 90) area = 90;
            prices[0].innerText = `${Math.ceil(((basisArea * 13 + (area - basisArea) * area / basisArea * 13) * k1 * k2 * k3 / 10) * 1.2) * 10 + 100 - eng} BYN`;
            prices[1].innerText = `${Math.ceil(((basisArea * 21 + (area - basisArea) * area / basisArea * 21) * k1 * k2 * k3 / 10) * 1.2) * 10 + 100 - eng} BYN`;
            prices[2].innerText = `${Math.ceil(((basisArea * 47 + (area - basisArea) * area / basisArea * 47) * k1 * k2 * k3 / 10) * 1.2) * 10 + 100 - eng + geology} BYN`;
        } else {
        ...
        if (area > basisArea) {
            prices[0].innerText = `${Math.ceil((basisArea * 15 + (area - basisArea) * basisArea / area * 15) * k2 * k4 / 10 * 1.1) * 10 + 100 - eng} BYN`;
            prices[1].innerText = `${Math.ceil((basisArea * 24 + (area - basisArea) * basisArea / area * 24) * k2 * k4 / 10 * 1.1) * 10 + 100 - eng} BYN`;
            prices[2].innerText = `${Math.ceil((basisArea * 51.9 + (area - basisArea) * basisArea / area * 51.9) * k2 * k4 / 10 * 1.1) * 10 + 100 - eng + geology} BYN`;
        } else if (area > 0) {
            if (area < 60) area = 60;
            prices[0].innerText = `${Math.ceil((basisArea * 15 + (area - basisArea) * area / basisArea * 15) * k2 * k4 / 10 * 1.1) * 10 + 100 - eng} BYN`;
            prices[1].innerText = `${Math.ceil((basisArea * 24 + (area - basisArea) * area / basisArea * 24) * k2 * k4 / 10 * 1.1) * 10 + 100 - eng} BYN`;
            prices[2].innerText = `${Math.ceil((basisArea * 52 + (area - basisArea) * area / basisArea * 52) * k2 * k4 / 10 * 1.1) * 10 + 100 - eng + geology} BYN`;
        } else {
            prices[0].innerText = `0 BYN`;
            prices[1].innerText = `0 BYN`;
            prices[2].innerText = `0 BYN`;
